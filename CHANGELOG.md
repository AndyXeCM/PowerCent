...
## PowerCent v1.1.1 b30 (2024-06-25)

**版本更新:**

- 发布 PowerCent v1.1.1 b30
...
## PowerCent v1.1.1 b29 (2023-06-29)

>
> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b29
>
> **Bug修复:**
>
> - 修复打开根路径 `/` 时账号登录失效的问题
...
## PowerCent v1.1.1 b28 (2023-06-27)

**版本更新:**

- 发布 PowerCent v1.1.1 b28
...
## PowerCent v1.1.1 b27 (2023-06-27)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b27
>
> **功能改进:**
>
> - 更新 README.md

## PowerCent v1.1.1 b26 (2023-06-26)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b26
>
> **Bug 修复:**
>
> - 修复打开根路径 `/` 时账号登录失效的问题
...
## PowerCent v1.1.1 b25 (2020-12-03)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b25
>
> **Bug 修复:**
>
> - 更新 CentOS 7 yum 源配置文件

## PowerCent v1.1.1 b24 (2020-10-06)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b24
>
> **功能改进:**
>
> - 优化主界面内存统计信息及自动刷新开关
...
## PowerCent v1.1.1 b23 (2020-05-13)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b23
>
> **Bug 修复:**
>
> - 修复: 更新 centos-release-7 链接地址

## PowerCent v1.1.1 b22 (2020-04-05)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b22
>
> **新增功能:**
>
> - 新增: 支持客户端模块
...
## PowerCent v1.1.1 b21 (2019-12-24)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b21
>
> **新增功能:**
>
> - 新增: FTP 客户端模块
...
## PowerCent v1.1.1 b20 (2019-08-08)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b20
>
> **新增功能:**
>
...
## PowerCent v1.1.1 b19 (2019-04-02)

> **版本更新:**
>
> - 发布 PowerCent v1.1.1 b19
>
> **Bug 修复:**
>
...
## PowerCent v1.1.1 b18 (2019-02-23)

> **注意：由于项目名称的变更，导致本次更新需要全新安装，不能从之前的版本兼容升级，很抱歉因此给你带来不便。**
>
> **版本更新：**
>
> - 发布 PowerCent v1.1.1 b18
> - 项目统一使用 PowerCent 标识
>
> **Bug 修复：**
>
